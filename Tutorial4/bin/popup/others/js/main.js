...
ctx.initialize = function(params) {
	...
	if (typeof params === 'object') {
		...
		if (obj.icon) {
			if (!((obj.iconWidth > 0) && (obj.iconWidth <12))) {
				obj.iconWidth = 4;
			}
			var textWidth = 12 - obj.iconWidth;
			...
			//}else{
				...
				ourStructureForIcon = '<div class="icon-class col-xs-' + obj.iconWidth + '"><img src="' + obj.icon + '"/></div>';
				body.addClass("col-xs-" + textWidth);
			//}
		}else{
