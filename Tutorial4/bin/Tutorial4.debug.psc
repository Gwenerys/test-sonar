	...
	<PROCESSUS>
		<PROCESS Name="GLOBAL" Key="NoKey" Comment="Global Processus">
			...
			<SCRIPTS>
				...
				<SCRIPT Name="Ctx Popup Bootbox" Src="lib\ctx\ctx.popup.bootbox.js" Folder="Framework" />
				<SCRIPT Name="FSO library" Src="lib\utils\fso.js" Folder="Libraries" />
				<SCRIPT Name="WMI library" Src="lib\utils\wmi.js" Folder="Libraries" />
				<SCRIPT Name="WScript library" Src="lib\utils\wscript.js" Folder="Libraries" />
				<SCRIPT Name="Ctx Diagnostic" Src="lib\ctx\ctx.diagnostic.js" Folder="Framework" />
				<SCRIPT Name="Ctx Discovery" Src="lib\ctx\ctx.discovery.js" Folder="Framework" />
				<SCRIPT Name="Declarations" Src="tutorial4.resources.js" ReadOnly="Y" />
				<SCRIPT Name="Main" Src="tutorial4.js" />
				<SCRIPT Name="Test" Src="tutorial4.test.js" />
				<SCRIPT Name="AppliScenario" Src="appliscenario.js" />
				<SCRIPT Name="MainProject" Src="mainproject.js" />
			</SCRIPTS>
			<RESOURCES>
